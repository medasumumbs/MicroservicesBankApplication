...
public class MainController {
    ...
    public MainController(ReactiveUserDetailsServiceImpl reactiveUserDetailsServiceImpl, CurrenciesService currenciesService, AccountsService accountsService) {
